...
class FlipBookPainterLetterM extends CustomPainter {
  ...
  static (Path, int) path0(Size size) {
    ...
    path_0.cubicTo(
        size.width * 0.0006055711,
        size.height * 0.2705907,
        size.width * 0.0009476763,
        size.height * 0.3401688,
        size.width * 0.0009476763,
        size.height * 0.3834599);
    path_0.lineTo(size.width * 0.0009476763, size.height * 0.4050633);
    path_0.lineTo(size.width * 0.2456318, size.height * 0.4050633);
    path_0.cubicTo(
        size.width * 0.2465792,
        size.height * 0.4025738,
        size.width * 0.2475792,
        size.height * 0.4000844,
        size.width * 0.2486318,
        size.height * 0.3976371);
  ...
  static (Path, int) path2(Size size) {
    ...
    path_2.cubicTo(
        size.width * 0.2350526,
        size.height * 0.05852321,
        size.width * 0.2219474,
        size.height * 0.07358650,
        size.width * 0.2092368,
        size.height * 0.09122363);
    path_2.lineTo(size.width * 0.2092368, size.height * 0.07886076);
    path_2.cubicTo(size.width * 0.2082632, size.height * 0.03400844,
        size.width * 0.1861053, 0, size.width * 0.1591053, 0);
    path_2.lineTo(size.width * 0.05013158, 0);
    path_2.cubicTo(size.width * 0.02218421, 0, 0, size.height * 0.03556962, 0,
        size.height * 0.08037975);
    path_2.cubicTo(
        0,
        size.height * 0.1154852,
        size.width * 0.0001578947,
        size.height * 0.1586920,
        size.width * 0.0003157895,
        size.height * 0.2025316);
  ...
  static (Path, int) path3(Size size) {
    ...
    path_3.cubicTo(
        size.width * 0.2266318,
        size.height * 0.4808439,
        size.width * 0.2295266,
        size.height * 0.4638397,
        size.width * 0.2314476,
        size.height * 0.4545570);
    path_3.lineTo(size.width * 0.2324213, size.height * 0.4514768);
    path_3.lineTo(size.width * 0.2333950, size.height * 0.4483966);
    path_3.cubicTo(
        size.width * 0.2361582,
        size.height * 0.4338819,
        size.width * 0.2403161,
        size.height * 0.4190717,
        size.width * 0.2456845,
        size.height * 0.4050633);
  ...
  static (Path, int) path5(Size size) {
    ...
    path_5.cubicTo(
        size.width * 0.0009739921,
        size.height * 0.9532911,
        size.width * 0.02315821,
        size.height * 0.9888186,
        size.width * 0.05113184,
        size.height * 0.9888186);
    path_5.lineTo(size.width * 0.1765003, size.height * 0.9888186);
    path_5.cubicTo(
        size.width * 0.2044739,
        size.height * 0.9888186,
        size.width * 0.2266318,
        size.height * 0.9532489,
        size.width * 0.2266318,
        size.height * 0.9084388);
  ...
  static (Path, int) path14(Size size) {
    ...
    path_14.cubicTo(
        size.width * 0.3169474,
        0,
        size.width * 0.2814737,
        size.height * 0.01556962,
        size.width * 0.2486584,
        size.height * 0.04594937);
    path_14.lineTo(size.width * 0.2486584, size.height * 0.3976371);
    path_14.cubicTo(
        size.width * 0.2640526,
        size.height * 0.3613502,
        size.width * 0.2878947,
        size.height * 0.3324051,
        size.width * 0.3172895,
        size.height * 0.3324051);
    path_14.cubicTo(
        size.width * 0.3503421,
        size.height * 0.3324051,
        size.width * 0.3684474,
        size.height * 0.3647679,
        size.width * 0.3781316,
        size.height * 0.4050211);
    path_14.lineTo(size.width * 0.4374474, size.height * 0.4050211);
    path_14.lineTo(size.width * 0.4374474, size.height * 0.02177215);
    path_14.cubicTo(size.width * 0.4119737, size.height * 0.007552743,
        size.width * 0.3845263, 0, size.width * 0.3558421, 0);
    path_14.close();
    return (path_14, keyPosition);
  }
  ...
  static (Path, int) path16(Size size) {
    ...
    path_16.cubicTo(
        size.width * 0.5076316,
        size.height * 0.07751013,
        size.width * 0.4746842,
        size.height * 0.04253122,
        size.width * 0.4374474,
        size.height * 0.02177177);
    path_16.close();
    return (path_16, keyPosition);
  }
  ...
  static (Path, int) path6(Size size) {
    ...
    path_6.cubicTo(
        size.width * 0.6142895,
        size.height * 0.4746835,
        size.width * 0.6162105,
        size.height * 0.4515190,
        size.width * 0.6200789,
        size.height * 0.4345148);
    path_6.cubicTo(
        size.width * 0.6221316,
        size.height * 0.4245992,
        size.width * 0.6249211,
        size.height * 0.4146414,
        size.width * 0.6282895,
        size.height * 0.4051055);
    path_6.lineTo(size.width * 0.3781316, size.height * 0.4051055);
    path_6.cubicTo(
        size.width * 0.3865526,
        size.height * 0.4400422,
        size.width * 0.3886316,
        size.height * 0.4809283,
        size.width * 0.3886316,
        size.height * 0.5118143);
  ...
  static (Path, int) path8(Size size) {
    ...
    path_8.cubicTo(
        size.width * 0.3886316,
        size.height * 0.9517722,
        size.width * 0.4108158,
        size.height * 0.9872996,
        size.width * 0.4387632,
        size.height * 0.9872996);
    ...
    path_8.cubicTo(
        ...
        size.height * 0.9872996,
        size.width * 0.6142895,
        size.height * 0.9517300,
        size.width * 0.6142895,
        size.height * 0.9069198);
  ...
  static (Path, int) path17(Size size) {
    ...
    path_17.cubicTo(
        size.width * 0.6147105,
        size.height * 0.03856523,
        size.width * 0.5902105,
        size.height * 0.05970464,
        size.width * 0.5670263,
        size.height * 0.08814346);
    path_17.cubicTo(
        size.width * 0.5564211,
        size.height * 0.1005063,
        size.width * 0.5467632,
        size.height * 0.1144304,
        size.width * 0.5371316,
        size.height * 0.1298734);
    path_17.cubicTo(
        size.width * 0.5360526,
        size.height * 0.1278903,
        size.width * 0.5349737,
        size.height * 0.1259916,
        size.width * 0.5338684,
        size.height * 0.1240506);
    path_17.lineTo(size.width * 0.5338684, size.height * 0.4050633);
    path_17.lineTo(size.width * 0.6282632, size.height * 0.4050633);
    path_17.cubicTo(
        size.width * 0.6318684,
        size.height * 0.3948945,
        size.width * 0.6361842,
        size.height * 0.3851477,
        size.width * 0.6411579,
        size.height * 0.3762869);
    path_17.lineTo(size.width * 0.6411842, size.height * 0.3762869);
    path_17.close();
    return (path_17, keyPosition);
  }
  ...
  static (Path, int) path9(Size size) {
    ...
    path_9.cubicTo(
        size.width * 0.7029737,
        0,
        size.width * 0.6708421,
        size.height * 0.007848101,
        size.width * 0.6411579,
        size.height * 0.02409283);
    path_9.lineTo(size.width * 0.6411579, size.height * 0.2025316);
    path_9.lineTo(size.width * 0.9543947, size.height * 0.2025316);
    path_9.cubicTo(size.width * 0.9030789, size.height * 0.05763713,
        size.width * 0.8166579, 0, size.width * 0.7386579, 0);
    path_9.close();
  ...
  static (Path, int) path10(Size size) {
    ...
    path_10.cubicTo(
        ...
        size.height * 0.3507173,
        size.width * 0.6751053,
        size.height * 0.3324473,
        size.width * 0.6981842,
        size.height * 0.3324473);
    path_10.cubicTo(
        size.width * 0.7130263,
        size.height * 0.3324473,
        size.width * 0.7444211,
        size.height * 0.3324473,
        size.width * 0.7618947,
        size.height * 0.4050633);
    path_10.lineTo(size.width * 0.9951579, size.height * 0.4050633);
    path_10.cubicTo(
        size.width * 0.9881316,
        size.height * 0.3240928,
        size.width * 0.9737632,
        size.height * 0.2571308,
        size.width * 0.9544211,
        size.height * 0.2025316);
  ...
  static (Path, int) path11(Size size) {
    ...
    path_11.cubicTo(
        size.width * 0.7693947,
        size.height * 0.4362025,
        size.width * 0.7743421,
        size.height * 0.4806751,
        size.width * 0.7743421,
        size.height * 0.5442616);
    ...
    path_11.cubicTo(
        size.width,
        size.height * 0.4805063,
        size.width * 0.9983158,
        size.height * 0.4413924,
        size.width * 0.9951579,
        size.height * 0.4050633);
    path_11.close();
  ...
  static (Path, int) path13(Size size) {
    ...
    path_13.cubicTo(size.width * 0.9778421, size.height * 0.9972996, size.width,
        size.height * 0.9617300, size.width, size.height * 0.9169198);
    ...
    path_13.cubicTo(
        size.width * 0.7743421,
        size.height * 0.9602532,
        size.width * 0.7965263,
        size.height * 0.9957806,
        size.width * 0.8245000,
        size.height * 0.9957806);
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint0Fill.color = colorsOfPaths?[path_1.$2 - 1] ??
        AppColorPhonetics.lightBlueColor2.withOpacity(1.0);
    canvas.drawPath(path_1.$1, paint0Fill);

    (Path, int) path_3 = path2(size);
    Paint paint3Fill = Paint()..style = PaintingStyle.fill;
    paint3Fill.color = colorsOfPaths?[path_3.$2 - 1] ??
        AppColorPhonetics.lightBlueColor2.withOpacity(1.0);
    canvas.drawPath(path_3.$1, paint3Fill);

    (Path, int) path_4 = path3(size);
    Paint paint4Fill = Paint()..style = PaintingStyle.fill;
    paint4Fill.color = colorsOfPaths?[path_4.$2 - 1] ??
        AppColorPhonetics.lightBlueColor2.withOpacity(1.0);
    canvas.drawPath(path_4.$1, paint4Fill);

    (Path, int) path_5 = path4(size);
    Paint paint5Fill = Paint()..style = PaintingStyle.fill;
    paint5Fill.color = colorsOfPaths?[path_5.$2 - 1] ??
        AppColorPhonetics.lightBlueColor2.withOpacity(1.0);
    canvas.drawPath(path_5.$1, paint5Fill);

    (Path, int) path_7 = path5(size);
    Paint paint7Fill = Paint()..style = PaintingStyle.fill;
    paint7Fill.color = colorsOfPaths?[path_7.$2 - 1] ??
        AppColorPhonetics.lightBlueColor2.withOpacity(1.0);
    canvas.drawPath(path_7.$1, paint7Fill);

    (Path, int) path_16 = path14(size);
    Paint paint16Fill = Paint()..style = PaintingStyle.fill;
    paint16Fill.color = colorsOfPaths?[path_16.$2 - 1] ??
        AppColorPhonetics.lightBlueColor2.withOpacity(1.0);
    canvas.drawPath(path_16.$1, paint16Fill);

    (Path, int) path_18 = path16(size);
    Paint paint18Fill = Paint()..style = PaintingStyle.fill;
    paint18Fill.color = colorsOfPaths?[path_18.$2 - 1] ??
        AppColorPhonetics.lightBlueColor2.withOpacity(1.0);
    canvas.drawPath(path_18.$1, paint18Fill);

    (Path, int) path_8 = path6(size);
    Paint paint8Fill = Paint()..style = PaintingStyle.fill;
    paint8Fill.color = colorsOfPaths?[path_8.$2 - 1] ??
        AppColorPhonetics.lightBlueColor2.withOpacity(1.0);
    canvas.drawPath(path_8.$1, paint8Fill);
    //
    (Path, int) path_9 = path7(size);
    Paint paint9Fill = Paint()..style = PaintingStyle.fill;
    paint9Fill.color = colorsOfPaths?[path_9.$2 - 1] ??
        AppColorPhonetics.lightBlueColor2.withOpacity(1.0);
    canvas.drawPath(path_9.$1, paint9Fill);
    //
    (Path, int) path_10 = path8(size);
    Paint paint10Fill = Paint()..style = PaintingStyle.fill;
    paint10Fill.color = colorsOfPaths?[path_10.$2 - 1] ??
        AppColorPhonetics.lightBlueColor2.withOpacity(1.0);
    canvas.drawPath(path_10.$1, paint10Fill);
    //
    (Path, int) path_11 = path9(size);
    Paint paint11Fill = Paint()..style = PaintingStyle.fill;
    paint11Fill.color = colorsOfPaths?[path_11.$2 - 1] ??
        AppColorPhonetics.lightBlueColor2.withOpacity(1.0);
    canvas.drawPath(path_11.$1, paint11Fill);
    //
    (Path, int) path_12 = path10(size);
    Paint paint12Fill = Paint()..style = PaintingStyle.fill;
    paint12Fill.color = colorsOfPaths?[path_12.$2 - 1] ??
        AppColorPhonetics.lightBlueColor2.withOpacity(1.0);
    canvas.drawPath(path_12.$1, paint12Fill);

    //
    (Path, int) path_13 = path11(size);
    Paint paint13Fill = Paint()..style = PaintingStyle.fill;
    paint13Fill.color = colorsOfPaths?[path_13.$2 - 1] ??
        AppColorPhonetics.lightBlueColor2.withOpacity(1.0);
    canvas.drawPath(path_13.$1, paint13Fill);
    //
    (Path, int) path_14 = path12(size);
    Paint paint14Fill = Paint()..style = PaintingStyle.fill;
    paint14Fill.color = colorsOfPaths?[path_14.$2 - 1] ??
        AppColorPhonetics.lightBlueColor2.withOpacity(1.0);
    canvas.drawPath(path_14.$1, paint14Fill);
    //
    (Path, int) path_15 = path13(size);
    Paint paint15Fill = Paint()..style = PaintingStyle.fill;
    paint15Fill.color = colorsOfPaths?[path_15.$2 - 1] ??
        AppColorPhonetics.lightBlueColor2.withOpacity(1.0);
    canvas.drawPath(path_15.$1, paint15Fill);

    (Path, int) path_19 = path17(size);
    Paint paint19Fill = Paint()..style = PaintingStyle.fill;
    paint19Fill.color = colorsOfPaths?[path_19.$2 - 1] ??
        AppColorPhonetics.lightBlueColor2.withOpacity(1.0);
    canvas.drawPath(path_19.$1, paint19Fill);
  }
